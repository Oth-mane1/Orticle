...
namespace Control_Panel
{
    public partial class signal : Form
    {
        ...
        {
            // TODO: cette ligne de code charge les données dans la table 'dbOrticleDataSet5.signalOrt'. Vous pouvez la déplacer ou la supprimer selon les besoins.
            this.signalOrtTableAdapter.Fill(this.dbOrticleDataSet5.signalOrt);
        }
